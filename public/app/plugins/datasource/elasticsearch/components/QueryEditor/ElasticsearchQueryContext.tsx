...
import { aliasPatternReducer, queryReducer, initQuery, esqlQueryReducer } from './state';
...
export const ElasticsearchProvider = ({
  ...
  const reducer = combineReducers<
    Pick<ElasticsearchDataQuery, 'query' | 'esqlQuery' | 'alias' | 'metrics' | 'bucketAggs'>
  >({
    query: queryReducer,
    esqlQuery: esqlQueryReducer,
